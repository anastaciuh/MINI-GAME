...
const TeknisPengunggahan = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-cover bg-center bg-[url('/images/bgrealmobile.png')] md:bg-[url('/images/bgrealdesktop.png')]"
        >
